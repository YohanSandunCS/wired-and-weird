...
class Config:
    ...
    # Other Sensors
    # WARNING: Default pins 16/20 conflict with motor enable pins!
    # Change these to unused GPIO pins if you connect proximity/bump sensors.
    PROXIMITY_SENSOR = int(os.getenv('PROXIMITY_SENSOR', '24'))
    BUMP_SENSOR = int(os.getenv('BUMP_SENSOR', '25'))
